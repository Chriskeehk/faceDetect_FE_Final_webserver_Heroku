	...
	return (
		<div className='center ma'>
			<div className='absolute mt3'>
				<img id='inputimage' alt='myImage' src={imageUrl} width='600px' height='auto' />
				<div>
					{	
						box.map((item, i) => {
							return ( 
...
//https://lh3.googleusercontent.com/proxy/ci4gAlRgG1EEofWACpHYiR53YdVSNE3hY1C7XQhbaLTNxHIWTFPZjZiP2KgU-37nswyix2Yg6BIKoNWK6Blmced8WiVMvPCaYUhY
